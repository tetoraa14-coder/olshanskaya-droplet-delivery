...
const About = () => (
  <main className="container py-12 max-w-3xl">
    ...
    <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
      Компания «Ольшанская» — надёжный поставщик чистой артезианской воды в Донецке и области.
    ...
    <div className="grid sm:grid-cols-2 gap-6 mb-10">
      {[
        { icon: Droplets, title: "Качество воды", desc: "Вода из артезианских скважин, прошедшая многоступенчатую очистку и лабораторный контроль." },
